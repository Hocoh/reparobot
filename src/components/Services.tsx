...
const Services: React.FC = () => {
      ...
      <Grid item xs={12} sm={6} key={i}>
        <Tooltip title="Cliquez pour ouvrir le formulaire" followCursor>
          <Box
            ...
            // }}
          >
            <Typography variant="h3" gutterBottom sx={{ fontWeight: 600 }} itemProp="name">
              {item.name}
            </Typography>
  ...
  const memoizedServices = useMemo(() => services.map(renderServiceCard), [services, renderServiceCard]);

  return (
    <section id="services" ref={topRef} aria-labelledby="services-title" itemScope itemType="https://schema.org/Service">
      <Box
        sx={{
          paddingTop: 5,
          paddingBottom: 10,
      ...
      >
        <Box marginBottom={4}>
          ...
          >
            Nous vous proposons une large gamme de services pour l'entretien de votre robot.
          </Typography>
        </Box>
        <Container>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="confirm-dialog-description">
                Vous avez des modifications non enregistrées. Êtes-vous sûr de vouloir fermer le formulaire ?
              </DialogContentText>
            </DialogContent>
            <DialogActions>
